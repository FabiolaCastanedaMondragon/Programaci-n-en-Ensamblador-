...
.data
    ...
    menor_mensaje db 10,13,"El n?mero menor es: $"
    numero1 db ?
    numero2 db ?
    resultado db 0
.code
main proc
    ...
    ; Si no, bl es menor o igual
    mov al, bl             ; Cargar el n?mero menor en al

es_menor:
    mov resultado, al      ; Guardar el resultado (el n?mero menor)

    ; Mostrar el resultado
    mov ah, 09h            ; Mostrar mensaje "El n?mero menor es: "
